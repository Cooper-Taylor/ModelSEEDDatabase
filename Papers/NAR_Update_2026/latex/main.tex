...
%%  [ ] FIGURES -- the database home page may NOT be used as a typeset figure.
%%      A representative screenshot of a query result IS allowed.
...
%%  [ ] SUBMISSION -- six suggested referees (name, institute, email),
...
%% Layout options: contemporary|modern|traditional  x  large|medium|mediumone|small
