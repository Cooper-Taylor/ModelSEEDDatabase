...
Paper-scoped copy of the make-plot skill runner (logs to latex/figures/_regen_logs).
repo, or set FIGURES_LOG_DIR / FIGURES_PYTHON in the environment.
...
LOG_DIR = Path(os.environ.get("FIGURES_LOG_DIR", ROOT / "latex" / "figures" / "_regen_logs"))
PYTHON = os.environ.get("FIGURES_PYTHON", sys.executable)
